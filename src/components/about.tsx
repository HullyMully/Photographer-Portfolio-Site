        ...
        <div className="flex flex-col md:flex-row items-center gap-16 max-w-6xl mx-auto">
          ...
          <div className="w-full md:w-3/5">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
              <p className="mb-4">Привет! Я Алекс Митчелл, фотограф из Портленда, штат Орегон. Моя страсть к фотографии началась семь лет назад, когда я впервые взял в руки камеру. С тех пор я снимаю пейзажи и портреты, стараясь запечатлеть особые моменты и эмоции в каждом кадре.</p>
              <p className="mb-4">Мой подход к фотографии основан на искренности и внимании к деталям. Я верю, что каждый снимок должен рассказывать историю и передавать настроение момента. Работая с клиентами, я стараюсь создать комфортную атмосферу, чтобы получить наиболее естественные и выразительные кадры.</p>
